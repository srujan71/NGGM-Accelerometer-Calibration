...
if __name__ == "__main__":
    ...
    nominal_settings_hf = {'Thrust': 2e-6, 'Duration': 86400, 'Frequency': 0.1, 'Length': 0.6, 'Bandwidth': 4, 'Layout': 2, 'Axis': 'x'}
    for freq_sh in frequencies:
        nominal_settings = {'Thrust': 2e-6, 'Duration': 86400, 'Frequency': freq_sh, 'Length': 0.6, 'Bandwidth': 4, 'Layout': 2, 'Axis': 'x'}

        settings = {'Seed': list(range(1, 200))}
        ...
        folder_path = current_dir + f"/../SimulationOutput/Output/Sensitivity_analysis/One_at_a_time/Frequency_analysis/avg_removed/f_{freq_sh}/"
