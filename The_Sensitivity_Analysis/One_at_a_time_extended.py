...
if __name__ == "__main__":
    ...
    for th_idx, th in enumerate(nominal_thrust):
        nominal_settings_hf = {'Thrust': th, 'Duration': 86400, 'Frequency': 0.1, 'Length': 0.6, 'Bandwidth': 4, 'Layout': 2, 'Axis': 'x'}
        nominal_settings = {'Thrust': th, 'Duration': 86400, 'Frequency': 1e-2, 'Length': 0.6, 'Bandwidth': 4, 'Layout': 2, 'Axis': 'x'}

        settings = {'Duration': [21600, 43200, 64800],
                    'Length': [0.4, 0.8],
                    'Layout': [1, 3],
                    }
        ...
        for seed in seeds:
            ...
            folder_path = current_dir + f"/../SimulationOutput/Output/Sensitivity_analysis/One_at_a_time/Freq_0.01_30_seeds/Thrust_{th}/Seed_{seed}/"
